...
PRODUCTS = [
    ...
    # BLP
    ("BLP_LIP_001","BLP_001","Lip Coat","Lip Coat","liquid_lipstick","velvet_matte",233000),
    ("BLP_LIP_002","BLP_001","Lip Bullet","Lip Bullet","lipstick_bullet","satin",161000),
    ("BLP_LIP_003","BLP_001","Airy Tint","Airy Tint","lip_tint","tint",120000),
    ("BLP_LIP_004","BLP_001","Lip Vinyl","Lip Vinyl","lip_gloss","gloss",90000),
    ("BLP_LIP_005","BLP_001","Lip Petals","Lip Petals","lip_tint","glossy_tint",135000),
    # Make Over
...
# (shade_id, product_id, brand_id, number, name, hex, undertone)
SHADES = [
    # ── WARDAH Long Lasting ──
    ...
    # ── MAYBELLINE SuperStay Matte Ink (sample) ──
    ...
    # ── BLP Lip Coat ──
    ("BLP_001_01","BLP_LIP_001","BLP_001","01","Butter Fudge","#C49A70","warm"),
    ("BLP_001_02","BLP_LIP_001","BLP_001","02","Peach Soda","#E09070","warm"),
    ("BLP_001_03","BLP_LIP_001","BLP_001","03","Pumpkin Sorbet","#C86840","warm"),
    ("BLP_001_04","BLP_LIP_001","BLP_001","04","Ginger Bread","#B06840","warm"),
    ("BLP_001_05","BLP_LIP_001","BLP_001","05","Maple Waffle","#A07868","neutral"),
    ("BLP_001_06","BLP_LIP_001","BLP_001","06","Candy Apple","#C83830","warm"),
    ("BLP_001_07","BLP_LIP_001","BLP_001","07","Burnt Cinnamon","#904030","warm"),
    ("BLP_001_08","BLP_LIP_001","BLP_001","08","Persimmon Pie","#C07870","neutral"),
    ("BLP_001_09","BLP_LIP_001","BLP_001","09","Lavender Cream","#C090B0","cool"),
    ("BLP_001_10","BLP_LIP_001","BLP_001","10","Peppermint Pink","#E090A0","cool"),
    ("BLP_001_11","BLP_LIP_001","BLP_001","11","Bloody Mary","#781828","cool"),
    ("BLP_001_12","BLP_LIP_001","BLP_001","12","Beet Me","#A02850","cool"),
    ("BLP_001_13","BLP_LIP_001","BLP_001","13","Red Velvet","#901830","cool"),
    ("BLP_001_14","BLP_LIP_001","BLP_001","14","Caramel Champagne","#C09080","neutral"),
    # ── BLP Lip Bullet ──
    ("BLP_002_01","BLP_LIP_002","BLP_001","01","Pavlova","#D09880","warm"),
    ("BLP_002_02","BLP_LIP_002","BLP_001","02","Licorice","#6A2838","cool"),
    ("BLP_002_03","BLP_LIP_002","BLP_001","03","Biscotti","#D08060","warm"),
    ("BLP_002_04","BLP_LIP_002","BLP_001","04","Carnation","#B83040","cool"),
    ("BLP_002_05","BLP_LIP_002","BLP_001","05","River","#A07878","neutral"),
    ("BLP_002_06","BLP_LIP_002","BLP_001","06","Pebble","#8B7068","warm"),
    ("BLP_002_07","BLP_LIP_002","BLP_001","07","Hazel","#906050","warm"),
    # ── MAKE OVER Powerstay ──
...
def init_db():
    ...
    conn.close()
    print(f"  Embedded data inserted: {total} shades from {len(BRANDS)} brands")
